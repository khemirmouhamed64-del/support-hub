...
@section('content')
    ...
    <div class="print-header" style="display:none; justify-content:space-between; align-items:flex-start; padding-bottom:12px; margin-bottom:16px; border-bottom:2px solid #1a2035;">
        <div>
            ...
            <p class="mb-0 text-muted small">{{ __('reports.print_subtitle') }}</p>
        </div>
        <div class="text-right">
            <p class="mb-0 small font-weight-bold" id="print-range-label"></p>
            <p class="mb-0 small text-muted">{{ __('reports.generated') }} {{ now()->format('d/m/Y H:i') }}</p>
        </div>
    </div>
            ...
            <div class="form-row align-items-end">
                ...
                <div class="col-auto mb-0">
                    <button id="btn-apply" class="btn btn-primary btn-sm px-4">
                        <i class="fas fa-chart-bar mr-1"></i>{{ __('reports.generate') }}
                    </button>
                </div>
    ...
    <div id="report-empty" class="text-center py-5 text-muted">
        ...
        <p class="mb-1">{!! __('reports.empty_hint') !!}</p>
        <small>{{ __('reports.max_range') }}</small>
    </div>
    ...
    <div id="report-loading" class="text-center py-5" style="display:none;">
        ...
        <p class="text-muted mb-0">{{ __('reports.loading') }}</p>
    </div>
    ...
    <div id="report-content" style="display:none;">
        ...
        <div class="report-actions d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <button id="btn-export-pdf" class="btn btn-sm btn-outline-danger mr-2">
                    <i class="fas fa-file-pdf mr-1"></i>{{ __('reports.export_pdf') }}
                </button>
                <a id="btn-export-csv" href="#" class="btn btn-sm btn-success">
                    <i class="fas fa-file-excel mr-1"></i>{{ __('reports.export_csv') }}
                </a>
            </div>
        </div>
                ...
                <div class="card report-kpi-card" style="border-left:4px solid #3498db;">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <div class="text-uppercase font-weight-bold text-muted" style="font-size:.68rem; letter-spacing:.06em;">{{ __('reports.total_tickets') }}</div>
                                <div class="h2 mb-0 font-weight-bold mt-1" id="kpi-total">—</div>
                                <div class="small text-muted">{{ __('reports.in_period') }}</div>
                            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card report-kpi-card" style="border-left:4px solid #27ae60;">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <div class="text-uppercase font-weight-bold text-muted" style="font-size:.68rem; letter-spacing:.06em;">{{ __('reports.resolved') }}</div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card report-kpi-card" style="border-left:4px solid #f39c12;">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <div class="text-uppercase font-weight-bold text-muted" style="font-size:.68rem; letter-spacing:.06em;">{{ __('reports.pending') }}</div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="card report-kpi-card" style="border-left:4px solid #9b59b6;">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <div class="text-uppercase font-weight-bold text-muted" style="font-size:.68rem; letter-spacing:.06em;">{{ __('reports.avg_resolution') }}</div>
                                <div class="h2 mb-0 font-weight-bold mt-1" id="kpi-avg">—</div>
                                <div class="small text-muted">{{ __('reports.in_resolved') }}</div>
                            </div>
        ...
        {{-- ── Charts Row 1: Status doughnut + Incident bar ── --}}
        <div class="row mb-4">
            <div class="col-md-4 mb-3">
                <div class="card chart-card h-100">
                    <div class="card-header">
                        <i class="fas fa-circle-notch mr-1 text-muted"></i><strong>{{ __('reports.by_status') }}</strong>
                    </div>
            ...
            <div class="col-md-8 mb-3">
                <div class="card chart-card h-100">
                    <div class="card-header">
                        <i class="fas fa-robot mr-1 text-muted"></i><strong>{{ __('reports.by_incident') }}</strong>
                    </div>
                    <div class="card-body">
        ...
        {{-- ── Charts Row 2: Assignee + Module ── --}}
        <div class="row mb-4">
            <div class="col-md-6 mb-3">
                <div class="card chart-card h-100">
                    <div class="card-header">
                        <i class="fas fa-user-cog mr-1 text-muted"></i><strong>{{ __('reports.by_assignee') }}</strong>
                    </div>
                    <div class="card-body">
                        <div style="position:relative; height:230px;">
            ...
            <div class="col-md-6 mb-3">
                <div class="card chart-card h-100">
                    <div class="card-header">
                        <i class="fas fa-cubes mr-1 text-muted"></i><strong>{{ __('reports.by_module') }}</strong>
                    </div>
                    <div class="card-body">
                        <div style="position:relative; height:230px;">
            ...
            <div class="col-12">
                <div class="card chart-card">
                    <div class="card-header">
                        ...
                        <strong>{{ __('reports.by_client') }}</strong>
                        <small class="text-muted ml-1">({{ __('reports.top_10') }})</small>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-sm mb-0" id="table-clients">
                            <thead class="thead-light">
                                <tr>
                                    <th style="width:4%">{{ __('reports.tbl_rank') }}</th>
                                    <th>{{ __('reports.tbl_client') }}</th>
                                    <th class="text-right" style="width:14%">{{ __('reports.tbl_tickets') }}</th>
                                    <th style="width:48%">{{ __('reports.tbl_distribution') }}</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
